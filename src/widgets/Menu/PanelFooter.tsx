...
const PanelFooter: React.FC<Props> = ({
 ...
 <img
      ...
      <SettingsEntry>
        ...
        <Button variant="text" onClick={() => {toggleTheme(!isDark); window.location.reload()}}>
          <Flex alignItems="center">
            {<SunIcon color="textSubtle" width="24px" />}
            {/* <Text color="textDisabled" mx="4px">
              /
            </Text> */}
            {/* {!isDark && <MoonIcon color={isDark ? "text" : "textDisabled"} width="24px" />} */}
          </Flex>
        </Button>
